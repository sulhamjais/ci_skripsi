            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="x_title">
                        <h2>Daftar Permintaan Surat Aktif Kuliah</h2>
                ...
                <tr >
                  ...
                  <td>
                    ...
                    <input type="hidden" name="id<?php echo $list['id']?>" id="id<?php echo $list['id']?>" value="<?php echo $list['id']?>"> </input>
                        <!--  <a href="<?php echo base_url(); ?>aktifkuliah/suratselesai/<?php echo $list['id']?>"><label class="btn btn-info" ><span class="glyphicon glyphicon-ok" aria-hidden="true"></label></a>
                          <a href="<?php echo base_url(); ?>aktifkuliah/suratproses/<?php echo $list['id']?>"><label class="btn btn-warning" ><span class="glyphicon glyphicon-time" aria-hidden="true"></label></a>
                          <a href="<?php echo base_url(); ?>aktifkuliah/suratbatal/<?php echo $list['id']?>"><label class="btn btn-danger" ><span class="glyphicon glyphicon-remove" aria-hidden="true"></label></a> &nbsp;
                  --></td>
                </tr>
                <?php } ?>
    ...
    function getval(sel)
    {
     ...
     $('select').on('change', function() {
      ...
      switch (this.value) {
        case '1':
          window.location='<?php echo base_url(); ?>aktifkuliah/suratproses/'+document.getElementById('id'+id).value;
          break;
        case '2':
          window.location='<?php echo base_url(); ?>aktifkuliah/suratkefakultas/'+document.getElementById('id'+id).value;
          break;
        case '3':
          window.location='<?php echo base_url(); ?>aktifkuliah/suratselesai/'+document.getElementById('id'+id).value;
          break;
        case '4':
          window.location='<?php echo base_url(); ?>aktifkuliah/suratbatal/'+document.getElementById('id'+id).value;
          break;
        default:
