...
<div id="page-inner">
    ...
    <div class="row">
        ...
        <div class="x_title">
            <h2>Daftar Permintaan Surat Permohonan Kerja Praktek</h2>
    ...
    <td><?php echo $list['jenissurat'];?></td>
      <td>
        <select name="status<?php echo $list['id']?>" id="status<?php echo $list['id']?>" onchange="getval(this);">
          ...
          <!--<a href="<?php echo base_url(); ?>kerjapraktek/suratselesai/<?php echo $list['id']?>"><label class="btn btn-info" ><span class="glyphicon glyphicon-ok" aria-hidden="true"></label></a>
          <a href="<?php echo base_url(); ?>kerjapraktek/suratproses/<?php echo $list['id']?>"><label class="btn btn-warning" ><span class="glyphicon glyphicon-time" aria-hidden="true"></label></a>
          <a href="<?php echo base_url(); ?>kerjapraktek/suratbatal/<?php echo $list['id']?>"><label class="btn btn-danger" ><span class="glyphicon glyphicon-remove" aria-hidden="true"></label></a> &nbsp;
          -->
      </td>
    </tr>
    <?php } ?>
...
function getval(sel)
{
 ...
 $('select').on('change', function() {
  ...
  switch (this.value) {
    case '1':
      window.location='<?php echo base_url(); ?>kerjapraktek/suratproses/'+document.getElementById('id'+id).value;
      break;
    case '2':
      window.location='<?php echo base_url(); ?>kerjapraktek/suratkefakultas/'+document.getElementById('id'+id).value;
      break;
    case '3':
      window.location='<?php echo base_url(); ?>kerjapraktek/suratselesai/'+document.getElementById('id'+id).value;
      break;
    case '4':
      window.location='<?php echo base_url(); ?>kerjapraktek/suratbatal/'+document.getElementById('id'+id).value;
      break;
    default:
