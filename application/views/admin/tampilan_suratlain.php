...
<div id="page-inner">
    ...
    <div class="row">
        ...
        <div class="x_title">
            <h2>Daftar Permintaan Lainnya</h2>
  ...
  <tbody align="center">
    ...
    <tr >
      ...
      <td>
        ...
        <!--
          <a href="<?php echo base_url(); ?>suratlain/suratselesai/<?php echo $list['id']?>"><label class="btn btn-info" ><span class="glyphicon glyphicon-ok" aria-hidden="true"></label></a>
          <a href="<?php echo base_url(); ?>suratlain/suratproses/<?php echo $list['id']?>"><label class="btn btn-warning" ><span class="glyphicon glyphicon-time" aria-hidden="true"></label></a>
          <a href="<?php echo base_url(); ?>suratlain/suratbatal/<?php echo $list['id']?>"><label class="btn btn-danger" ><span class="glyphicon glyphicon-remove" aria-hidden="true"></label></a> &nbsp;
        -->
      </td>
    </tr>
    <?php } ?>
...
function getval(sel)
{
 ...
 $('select').on('change', function() {
  ...
  switch (this.value) {
    case '1':
      window.location='<?php echo base_url(); ?>suratlain/suratproses/'+document.getElementById('id'+id).value;
      break;
    case '2':
      window.location='<?php echo base_url(); ?>suratlain/suratkefakultas/'+document.getElementById('id'+id).value;
      break;
    case '3':
      window.location='<?php echo base_url(); ?>suratlain/suratselesai/'+document.getElementById('id'+id).value;
      break;
    case '4':
      window.location='<?php echo base_url(); ?>suratlain/suratbatal/'+document.getElementById('id'+id).value;
      break;
    default:
