<div class="container" id="container">
  <div class="row">
    <div class="box">
      <div class="col-lg-12">
        <hr>
          <h2 class="intro-text text-center"> <strong>Pilih Surat</strong></h2>
        <hr>
      </div>

      <form action="<?php echo base_url('buatsurat/ajukan_surat'); ?>" method="post">
        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="col-lg-12">
            <h2 class="intro-text text-center"> <strong>Surat Aktif Kuliah</strong></h2>
          </div>
          <div class="box-form">
            <div class="form-group">
              <label >Nama</label>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label >Tempat</label>
                <input type="text" class="form-control" id="tempatlahir" name="tempatlahir" value="<?php echo $this->session->userdata('tempat_lahir');?>" placeholder="Tempat Lahir">
              </div>
              <div class="form-group col-md-6">
                <label >Tanggal Lahir</label>
                <input type="date" class="form-control" id="ttl" name="ttl" value="<?php echo $this->session->userdata('ttl');?>" placeholder="Tanggal Lahir">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label >Alamat</label>
              <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $this->session->userdata('alamat');?>" placeholder="Alamat">
            </div>
